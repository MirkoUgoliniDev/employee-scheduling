...
CREATE TABLE email_settings (
    ...
    start_tls INTEGER NOT NULL DEFAULT 1 CHECK (start_tls IN (0, 1)),
...
CREATE TABLE demo_data_parameters (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    days_in_schedule INTEGER NOT NULL,
...
INSERT INTO structures (id, name, address, phone) VALUES (1, 'Default', '', '');
INSERT INTO skill_type (id, description) VALUES (1, 'Required');
INSERT INTO skill_type (id, description) VALUES (2, 'Optional');
INSERT INTO employee_date_type (id, description) VALUES (1, 'Desired');
INSERT INTO employee_date_type (id, description) VALUES (2, 'Undesired');
INSERT INTO employee_date_type (id, description) VALUES (3, 'Unavailable');
INSERT INTO languages (id, code, description, active) VALUES (1, 'it', 'Italiano', 1);
INSERT INTO languages (id, code, description, active) VALUES (2, 'en', 'English', 0);
INSERT INTO languages (id, code, description, active) VALUES (3, 'fr', 'Français', 0);
INSERT INTO languages (id, code, description, active) VALUES (4, 'es', 'Español', 0);
INSERT INTO languages (id, code, description, active) VALUES (5, 'de', 'Deutsch', 0);
